...
class CommandeTreatment extends ConsumerStatefulWidget {
  const CommandeTreatment({Key? key}) : super(key: key);

  @override
  CommandeTreatmentState createState() => CommandeTreatmentState();
}

class CommandeTreatmentState extends ConsumerState<CommandeTreatment> {
        ...
        builder: (context, constraints) {
          if (constraints.maxWidth >= 900) {
            return horizontalView(height(context), width(context), context,
                viewModel.listCommandeTraitement);
          } else {
                                ...
                                children: [
                                  Expanded(
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        modificationCommande(context, 'ANNULER',
