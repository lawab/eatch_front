...
class CommandeDone extends ConsumerStatefulWidget {
  const CommandeDone({Key? key}) : super(key: key);

  @override
  CommandeDoneState createState() => CommandeDoneState();
}

class CommandeDoneState extends ConsumerState<CommandeDone> {
