...
class CommandePaid extends ConsumerStatefulWidget {
  const CommandePaid({Key? key}) : super(key: key);

  @override
  CommandePaidState createState() => CommandePaidState();
}

class CommandePaidState extends ConsumerState<CommandePaid> {
