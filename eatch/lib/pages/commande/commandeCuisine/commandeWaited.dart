...
class CommandeWaited extends ConsumerStatefulWidget {
  const CommandeWaited({Key? key}) : super(key: key);

  @override
  CommandeWaitedState createState() => CommandeWaitedState();
}

class CommandeWaitedState extends ConsumerState<CommandeWaited> {
