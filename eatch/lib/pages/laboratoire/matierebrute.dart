...
class MatiereBruteeState extends ConsumerState<MatiereBrutee> {
  ...
  Future<void> creationMatiereBrute(
    ...
    var url = Uri.parse(
        "http://192.168.1.105:4015/api/raws/create"); //13.39.81.126 // 13.39.81.126 //13.39.81.126
  ...
  Future<void> ajoutMatiereBrute(
    ...
    var url = Uri.parse(
        "http://192.168.1.105:4015/api/laboratories/updateProviding"); //13.39.81.126 // 13.39.81.126 //13.39.81.126
    final request = MultipartRequest(
      'PATCH',
      url,
      onProgress: (int bytes, int total) {
  ...
  Future<void> creationFournisseur(
    ...
    var url = Uri.parse(
        "http://192.168.1.105:4015/api/providers/create"); //13.39.81.126 // 13.39.81.126 //13.39.81.126
    final request = MultipartRequest(
      'POST',
      url,
      onProgress: (int bytes, int total) {
