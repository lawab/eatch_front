...
class PromotionAfficheState extends ConsumerState<PromotionAffiche> {
                                          ...
                                          children: [
                                            Expanded(
                                              child: ClipRRect(
                                                ...
                                                child: Image.network(
                                                  "http://192.168.1.34:5005${viewModel.listPromotion[index].image}",
                                                  fit: BoxFit.cover,
                                                ),
                                              ),
                                            ),
  ...
  Future<void> creationPromotion(
    ...
    var url = Uri.parse(
        "http://192.168.1.34:5005/api/promotions/create"); // 192.168.1.34:4009
  ...
  Future<http.Response> deletePromotion(
    ...
    try {
      ...
      var token = prefs.getString('token');
      String urlDelete =
          "http://192.168.1.34:5005/api/promotions/delete/$idPromotion"; // 192.168.1.34:4008 //$adressUrl
