...
class PromotionAfficheState extends ConsumerState<PromotionAffiche> {
  ...
  Future<void> creationPromotion(
    ...
    var url = Uri.parse(
        "http://192.168.11.110:5005/api/promotions/create"); // 192.168.11.110:4009
  ...
  Future<http.Response> deletePromotion(
    ...
    try {
      ...
      var token = prefs.getString('token');
      String urlDelete =
          "http://192.168.11.110:5005/api/promotions/delete/$idPromotion"; // 192.168.11.110:4008 //$adressUrl
